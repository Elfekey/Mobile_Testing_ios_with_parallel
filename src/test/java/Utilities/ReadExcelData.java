...
/*
/first we need The Below Dependencies to be add as jar files or maven Dependencies
*<dependency>
...
public class ReadExcelData {
    //####First OF all create an excel sheet inside your project path ####
    ...
    //##you have to provide test sheet name here if you have more than one sheet## and you want to use the one instead of the first one
    ...
    //if we are on mac use Numbers app then save file as excel xlsx
    //Globals
    ...
    //private String testDataFileNameFromUserString ="/TestData.xlsx"; //#####you have to provide you test data file name here with it's excetention###
    ...
    public ReadExcelData(String testDataFileNameFromUserString,String sheetNameFromUser) {//String sheetName
        testDataFilePath =System.getProperty("user.dir"); //get the project path
        try {
            //if we gonna change the folder or the test data file name we have to change it here also  /Excel/TestData.xlsx
            workbook = new XSSFWorkbook(testDataFilePath+"/"+testDataFileNameFromUserString+".xlsx");
    ...
    public ReadExcelData(String testDataFileNameFromUserString) {
        testDataFilePath =System.getProperty("user.dir"); //get the project pathx
        try {
            //if we gonna change the folder or the test data file name we have to change it here also  /Excel/TestData.xlsx
            workbook = new XSSFWorkbook(testDataFilePath+"/"+testDataFileNameFromUserString+".xlsx");
    ...
    public String GetDataByFirstRowDataNameOnly(String TestDataName) {//String TestDataName  String
        //will get by colum name first then convert to row name
        try
        {
            //##  here we try to geet the sheet name from code in constructor look at the constructor !! ##
